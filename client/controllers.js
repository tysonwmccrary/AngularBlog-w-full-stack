angular.module('myblog.controllers', [])
    ...
    .controller('ComposePostController', ['$scope', 'Post', 'Category', 'User', '$location', function ($scope, Post, Category, User, $location) {
        $scope.user = User.query();  //Uses the factories to recieve information from database.
    ...
    .controller('UserListController', ['$scope', 'User', function ($scope, User) {
        ...
        $scope.createUser = function () {
            ...
            u.$save(function () {
                ...
                $scope.user = User.query();  //Returns the list of the user once account is created.
            });
        }
    }])
    .controller('CategoryListController', ['$scope', 'Category', function ($scope, Category) {
        $scope.category = Category.query();
